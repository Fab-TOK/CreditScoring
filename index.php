    ...
    <form id="form" action="calcul.php" method="post">
        ...
        <div class="form-group">
           ...
           <div class="input-group">
               <input type="text" name="age" placeholder="Entrer l'age du client"/>
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <br />
            <div class="input-group">
                <input type="text" name="revenu" placeholder="Entrez le revenu"/>
            </div>
        </div>
        ...
        <div class="form-group">
           ...
           <br />
            <div class="input-group">
                <input type="text" name="activity" placeholder="Entrer la durée d'activité"/>
            </div>
        </div>
        ...
        <div class="form-group">
           ...
           <br/>
            <div class="input-group">
                <!-- <input type="text" name="motif" placeholder="Entrez le motif"/> -->
                <select name="motif" > 
        ...
        <div class="form-group">
           ...
           <br />
            <div class="input-group">
                <input type="text" name="montprete" placeholder="Entrez le montant prêté"/>
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <br />
             <div class="input-group">
                 <input type="text" name="taux" placeholder="Entrez le taux d'intérêt"/>
             </div>
        </div>
